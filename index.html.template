...
<head>
    ...
    <meta name="x:site" content="@ElectrumWallet"/>
    ...
    <div class="wrapper">
        ...
        <div style="float:right">
            <div id="social-icons">
                ...
                <a href="https://x.com/ElectrumWallet" class="icon-twitter"></a>
            </div>
            <div class="clear"></div>
            <div id="menu">
                <ul class="navigation">
...
<div id="content">
    <div class="wrapper">
        ...
        <div class="page" id="community">
            ...
            <h4>Forums and social media</h4>
            <ul>
                <li>Official announcements are made
                  on <a href="https://x.com/ElectrumWallet">Twitter</a>
                  and <a href="nostr:npub1zqnl6k7rkhjsexqq6j9u3t8mc2gd3xu9037wz4tj54cy33xq2k8qpqv2pm">nostr</a>.</li>
                <li>You can ask questions
                on <a href="https://bitcointalk.org/index.php?board=98.0">bitcointalk.org</a>
                as well as
                on <a href="https://www.reddit.com/r/Electrum/">Reddit</a></li>
            </ul>
            <h4>Plugins</h4>
            <ul>
              <li>List of Electrum plugins: <a href="https://plugins.electrum.org">plugins.electrum.org</a></li>
              <li><a href="https://bitcointalk.org/index.php?topic=5577365.0">Electrum plugins thread on bitcointalk</a></li>
            </ul>
            <h4>Development</h4>
            <ul>
            ...
            <ul>
              <li>Official Python implementation: <a href="https://github.com/spesmilo/electrumx">ElectrumX</a></li>
              <li>Alternative implementation (in Rust): <a href="https://github.com/romanz/electrs">Electrs</a></li>
